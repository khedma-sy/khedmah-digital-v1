...
END
\$roles\$;
ALTER ROLE "$RUNTIME_ROLE" NOLOGIN NOCREATEDB NOCREATEROLE INHERIT NOREPLICATION;
ALTER ROLE "$MIGRATION_ROLE" NOLOGIN NOCREATEDB NOCREATEROLE INHERIT NOREPLICATION;
