...
const EXPECTED_MIGRATIONS = [
  ...
  '025_mobility_requests.sql',
  '025_mobility_requests_rollback.sql',
  '026_cash_fulfillment_orders.sql',
  '026_cash_fulfillment_orders_rollback.sql',
  '027_professional_service_marketplace.sql',
  '027_professional_service_marketplace_rollback.sql',
  '028_khedmah_promotions.sql',
  '028_khedmah_promotions_rollback.sql',
  '029_admin_user_management.sql',
  '029_admin_user_management_rollback.sql',
  '030_operations_issue_center.sql',
  '030_operations_issue_center_rollback.sql',
  '031_admin_catalog_management.sql',
  '031_admin_catalog_management_rollback.sql',
  '032_mobility_fare_lifecycle.sql',
