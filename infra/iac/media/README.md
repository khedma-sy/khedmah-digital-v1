...
- Terraform writes to a temporary pending plan. The reviewed output path is published only after the post-plan root-state check succeeds; every rejected pending plan is deleted.
