...
test('database migration workflow governs every canonical pair through 030',async()=>{
  ...
  assert.match(workflow,/Product V2 billing credits\/subscriptions are approved scope/);
