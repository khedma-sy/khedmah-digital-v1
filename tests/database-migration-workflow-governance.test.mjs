...
test('database migration workflow governs every canonical pair through 020', async () => {
  ...
  const names = [
    ...
    '018_persistent_rate_limit_buckets', '019_remove_out_of_scope_subscription_schema',
