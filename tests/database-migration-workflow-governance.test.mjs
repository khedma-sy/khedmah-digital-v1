...
test('database migration workflow governs every canonical pair through 031',async()=>{
  ...
  assert.match(workflow,/Product V2 billing credits\/subscriptions and Taxi operational approvals are approved scope/);
