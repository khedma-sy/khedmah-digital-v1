...
test('database migration workflow governs every canonical pair through 034',async()=>{
  ...
  assert.match(workflow,/restaurant-funded food promotion claims are approved scope/);
  ...
  assert.match(workflow,/MIGRATION_034_ROLLBACK_BLOCKED/);
