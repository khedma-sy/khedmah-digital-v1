...
test('production migration 022 is explicit, backed up, checksum-bound and transactional', async () => {
  ...
  assert.match(workflow, /APPLY_KHEDMAH_MIGRATION_022_/);
  ...
  assert.match(workflow, /khedmah-before-022-/);
  ...
  assert.match(runner, /APPROVED_MIGRATION='022_expand_category_taxonomy'/);
  assert.match(runner, /APPROVED_SHA256='ac385b1262a80a75d4443662fce2fb1a858ebd8778a2bc6fdec65d8c1c805a8a'/);
