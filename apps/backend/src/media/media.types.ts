...
export type MediaOwnerType = 'business_profile' | 'professional_profile' | 'product_listing' | 'ad_listing' | 'user';
export type MediaMimeType = 'image/jpeg' | 'image/png' | 'image/webp';
export type MediaAssetType = 'logo' | 'cover' | 'gallery' | 'profile_image' | 'service_image' | 'product_image' | 'ad_image';
