      ...
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#fff;border:1px solid #e8dfd4;border-radius:20px;box-shadow:0 16px 48px rgba(16,52,82,.10);overflow:hidden">
        ...
        <tr><td style="padding:10px 36px 34px;text-align:right">
          ...
          <p style="margin:0 0 26px;text-align:center">
            <a href="${actionUrl}" style="display:inline-block;min-width:220px;padding:14px 24px;border-radius:10px;background:#155a91;color:#fff;text-decoration:none;font-size:16px;font-weight:700">${escapeHtml(input.actionLabel)}</a>
          </p>
          ...
          <p style="margin:0;padding:12px;border-radius:8px;background:#f7f9fa;direction:ltr;text-align:left;word-break:break-all;color:#16875f;font-size:12px"><a href="${actionUrl}" style="color:#16875f">${actionUrl}</a></p>
