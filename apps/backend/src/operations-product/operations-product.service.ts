...
import { advertisingPolicy } from '../products/product-policy';
@Injectable()
export class OperationsProductService {
  ...
  async contentGovernance(cookie:string|undefined){await this.actor(cookie,'security.manage');return this.repository.contentGovernance(advertisingPolicy());}
