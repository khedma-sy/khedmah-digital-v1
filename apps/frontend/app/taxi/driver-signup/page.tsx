...
export default function TaxiDriverSignupPage() {
  ...
  return <PageShell className={styles.page} label="الانضمام إلى خدمة تكسي">
    ...
    {error && <StatusMessage tone="danger">{error}{error.includes('تسجيل الدخول') && <div className={styles.actions}><ActionLink href="/auth/login?next=%2Ftaxi%2Fdriver-signup">تسجيل الدخول</ActionLink></div>}</StatusMessage>}
