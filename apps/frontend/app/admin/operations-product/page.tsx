...
export default function OperationsProductPage() {
  return <main id="foundation-content" className="operations-shell">
    <header className="operations-header"><div><p className="eyebrow">KHEDMA DIGITAL · ADMIN</p><h1>Operations Product</h1><p>مركز عمليات البنية التحتية والإنتاج مع صلاحيات مقيدة وتدقيق كامل.</p></div><span className="status-badge">جاهز للتهيئة · غير مفعّل للإنتاج</span></header>
