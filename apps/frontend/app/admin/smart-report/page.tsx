...
export default function SmartAdminReportPage() {
  ...
  return <main className="operations-shell" dir="rtl" aria-label="تقرير الموظف الإداري الذكي">
    <header className="operations-header"><div><p className="eyebrow">خدمة · مساعد إداري</p><h1>تقرير تطوير المنصة</h1><p>تحليل مجمع لآخر {report.analytics.periodDays} يومًا؛ يقدم اقتراحات ولا يتخذ قرارات تلقائية.</p></div><span className="status-badge">مراجعة بشرية إلزامية</span></header>
