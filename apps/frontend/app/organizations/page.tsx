...
export default function OrganizationsPage() {
  ...
  return <PageShell className={styles.page} label="المؤسسات والجهات">
    <PageHeader eyebrow="مساحة الأعمال" title="المؤسسات والجهات" description="أدر الجهات المرتبطة بحسابك وأعضاء الفريق والصلاحيات. إنشاء جهات جديدة غير متاح في الإصدار الحالي." actions={<div className={styles.headerActions}>
      <ActionLink href="/business-profiles"><PlatformIcon name="briefcase" size={18}/> ملفات الأعمال</ActionLink>
    ...
    {!isLoading && !error && organizations.length === 0 ? <EmptyState icon={<PlatformIcon name="grid" size={30}/>} title="لا توجد جهة مرتبطة بحسابك" description="إدارة الجهات الحالية مدعومة، بينما إنشاء جهة جديدة مؤجل في هذا الإصدار. يمكنك متابعة إدارة نشاطك التجاري أو ملفك المهني." actions={<><ActionLink href="/business-profiles">إدارة ملفات الأعمال</ActionLink><ActionLink href="/professional-profiles" variant="secondary">إدارة الملف المهني</ActionLink></>}/> : null}
