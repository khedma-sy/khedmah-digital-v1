...
export default function SellProductPage() {
  ...
  return <PageShell className={styles.page} label="عرض منتج للبيع"><div className={styles.formShell}>
    <PageHeader eyebrow="متجر خدمة" title="عرض منتج للبيع" description="أضف منتجًا حقيقيًا مرتبطًا بنشاطك. سيُراجع قبل ظهوره في المتجر." actions={<ActionLink href="/store/manage" variant="secondary">منتجاتي</ActionLink>}/>
