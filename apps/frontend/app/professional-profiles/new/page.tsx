...
export default function ProfessionalProfileEditorPage() {
  ...
  return <PageShell className={styles.page} label={profileId ? 'تعديل الملف المهني' : 'إنشاء ملف مهني'}>
    <div className={styles.formShell}>
      ...
      {error && <StatusMessage tone="danger">{error}{prefillFailed && <div className={styles.actions}><ActionButton type="button" variant="secondary" onClick={() => loadProfile()}>إعادة تحميل الملف</ActionButton></div>}</StatusMessage>}
